<template>
  <div class="widget-dataBlock">
    ...
    <property-number label="字体大小"  unit="px" option-key="style.font-size" :min="10" :max="1000" :step="1" />
    <property-number label="字体间距"  unit="px" option-key="style.letter-spacing":min="0" :max="30" :step="1" />
    ...
    <property-number label="边框粗细" unit="px" option-key="style.border-width" :min="0" :max="30" :step="1"/>
    ...
    <property-switch label="圆角" option-key="style.border-radius" :ui="['number-px','number-%']" :min="10" :max="30" :step="1">
    </property-switch>
