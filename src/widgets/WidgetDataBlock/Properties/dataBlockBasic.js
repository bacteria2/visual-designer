  ...
  render(h){
    return (
      <div class="widget-dataBlock">
        ...
        <property-number label="字体间距"  unit="px" option-key="style.letter-spacing" min={10} step={1} />
        ...
        <property-number label="边框粗细" unit="px" option-key="style.borderWidth" min={10} step={1} max={30}/>
        <property-color label="边框颜色" option-key="style.borderColor"/>
        <property-select label="线条类型" option-key="style.borderStyle"
