...
export default class D3Render extends Render {
  ...
  render (option) {
    ...
    this.createDashBoardChart(this.el, option.width, option.height, option.dataSet)
  }
  ...
  createDashBoardChart (id, width, height, dataSet) {
    var publicGraph = {},
      circlePng = dataSet.circlePng ? dataSet.circlePng : require('./image/big-circle.png'),
      valuePng = dataSet.valuePng ? dataSet.valuePng : require('./image/big-value.png')
