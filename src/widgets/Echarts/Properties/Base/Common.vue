<template>
  <div>
        ...
        <property-switch label="左上角横坐标（x1）" option-key="grid.x"
                         :ui="['number-px', 'number-%']"  :max="150" :step="2"/>
