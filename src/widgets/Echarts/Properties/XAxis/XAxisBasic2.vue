<template>
  <div>
    ...
    <property-color label="文本颜色"
                    option-key="xAxis[1].nameTextStyle.color"></property-color>
    <property-number label="字体大小"  unit="px"
                     option-key="xAxis[1].nameTextStyle.fontSize" ></property-number>
    <property-select label="字体样式"
                     option-key="xAxis[1].nameTextStyle.fontStyle"
    ...
    <property-select label="字体粗细"
                     option-key="xAxis[1].nameTextStyle.fontWeight"
    ...
    <property-select label="区间策略（数值轴）"
                     option-key="xAxis[1].scale"
                     :options="[{text:'自适应',value:true},{text:'总是包含0值',value:false}]"></property-select>
    <property-text label="刻度最小值（数值轴）"
                   option-key="xAxis[1].min"></property-text>
    <property-text label="刻度最大值（数值轴）"
                   option-key="xAxis[1].max"></property-text>
    <property-select label="起始和结束两端空白策略（目录轴）"
                     option-key="xAxis[1].boundaryGap"  :options="[{text:'留空',value:true},{text:'顶头',value:false}]"></property-select>
    <property-number label="分割段数（数值轴）"
                     option-key="xAxis[1].splitNumber"  :max="300" :step="1"></property-number>
    <divider/>
    <subheader text="其他样式"/>
    <property-select label="是否显示 x 轴"
                     option-key="xAxis[1].show"  :options="[{text:'是',value:true},{text:'否',value:false}]"></property-select>
    ...
    <property-number label="坐标轴名称与轴线之间的距离" unit="px"
                     option-key="xAxis[1].nameGap"  ></property-number>
