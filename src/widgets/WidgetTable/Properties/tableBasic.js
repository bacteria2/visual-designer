  ...
  render(h){
    return (
      <div class="widget-table">
        ...
        <property-number label="字体大小" unit="px" option-key="tableStyle.font-size" min={10}/>
        ...
        <property-color label="背景颜色" option-key="tableStyle.backgroundColor"/>
        <property-number label="边框粗细" unit="px" option-key="tableStyle.borderWidth" min={0} max={30} step={1}/>
        <property-color label="边框颜色" option-key="tableStyle.borderColor"/>
        <property-select label="线条类型" option-key="tableStyle.borderStyle"
                         options={[{text: '实线', value: 'solid'}, {text: '点状线', value: 'dotted'}, {
                           text: '虚线',
                           value: 'dashed'
                         }]}/>
        <property-select label="显示纵向边框" option-key="tableStyle.borderRight"
                         options={[{text: '是', value: true}, {text: '否', value: false}]}/>
        <divider/>

        <subheader text="表头样式"/>
        <property-number label="表头行高度" unit="px" option-key="thStyle.height" min={0} step={1}/>
        <property-color label="文本颜色" option-key="thStyle.color"/>
        <property-number label="字体大小" unit="px" option-key="thStyle.font-size" min={10}/>
        <property-text label="字体系列" option-key="thStyle.font-family"/>
        <property-select label="字体样式" option-key="thStyle.font-style"
                         options={[{text: '普通', value: 'normal'}, {
                           text: '斜体（italic）',
                           value: 'italic'
        ...
        <property-color label="背景颜色" option-key="thStyle.backgroundColor"/>
        <divider/>

        <subheader text="行样式"/>
        <property-number label="行高度" unit="px" option-key="rowStyle.height" min={0} step={1}/>
        <property-color label="文本颜色" option-key="rowStyle.color"/>
        <property-number label="字体大小" unit="px" option-key="rowStyle.font-size" min={10}/>
        ...
        <property-select label="带斑马纹" option-key="rowStyle.stripe" options={[{text: '是', value: true}, {
          text: '否',
          value: false
        }]}/>
        <property-color label="背景颜色" option-key="rowStyle.backgroundColor"/>
        <divider/>
      </div>)
  }
}
