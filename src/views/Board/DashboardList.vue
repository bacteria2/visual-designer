<template>
  <div class="dashboardList">
    <dashboard-base :show.sync="showDashboardBase" :edittingObj="edittingDashboard"
                    @doRefresh="filter"></dashboard-base>
    ...
    <main>
      <dashboard-box :dashboards="dashboards" @editDashboard="editDashboard" @desiDashboard="desiDashboard"
                     @addDashboard="addDashboard" @delDashboard="removeDashboards" @loadMore="loadMore"></dashboard-box>
    </main>
  </div>
</template>
<script>
  ...
  export default{
    ...
    methods: {
      ...
      desiDashboard(id){
        Router.push({name: 'DashboardDesigner', params: {dashboardId: id}})
      },
