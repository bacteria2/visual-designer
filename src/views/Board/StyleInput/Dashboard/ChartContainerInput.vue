    ...
    <el-collapse :value="['1','2','3']">
      <el-collapse-item title="图表选择" name="1">
        <div class="input_item" style="position: relative;height: 28px;">
          <mu-raised-button style="position: absolute;left: 80px;top: 0" primary
                            label="选择图表"  @click="showSelectCharDidget=true"></mu-raised-button>
        </div>
      </el-collapse-item>
      ...
      <el-collapse-item title="边框和背景" name="2">
        <div class="input_item">
          ...
          <el-select v-model="targetObj.style.borderStyle" style="margin-left: 12px;width:120px" placeholder="边框线类型"
                     value="solid">
