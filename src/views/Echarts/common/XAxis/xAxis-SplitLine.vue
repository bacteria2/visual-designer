<template>
  <div style="position: absolute;left: 60px;top: 0;bottom: 0;right: 0" class="blue-grey darken-1">
    ...
    <property-color label="分隔线颜色" option-key="xAxis.splitLine.lineStyle.color"></property-color>
    <property-number label="分隔线线宽"  unit="px" option-key="xAxis.splitLine.lineStyle.width" :min="0" :max="20" :step="1"></property-number>
    <property-select label="分隔线线的类型"  option-key="xAxis.splitLine.lineStyle.type"  :options="[{text:'实线',value:'solid'},{text:'虚线（dashed）',value:'dashed'},{text:'点状线（dotted）',value:'dotted'}]"></property-select>
    <property-number label="图形阴影的模糊大小"  unit="px" option-key="xAxis.splitLine.lineStyle.shadowBlur" ></property-number>
