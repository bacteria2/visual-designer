<template>
  <div>
    ...
    <property-switch label="X:"  :component-type="type" :series-index="index" option-key="center.x"  :ui="['number-px','number-%']" :min="0" :max="1400" :step="1"></property-switch>
    <property-switch label="Y:"  :component-type="type" :series-index="index" option-key="center.y" :ui="['number-px','number-%']" :min="0" :max="1400" :step="1"></property-switch>
    <divider/>
    <property-switch label="饼图半径"  :component-type="type" :series-index="index" option-key="radius" :ui="['number-px','number-%']" :min="0" :max="400" :step="1"></property-switch>
   <!-- <property-switch label="内:"  :component-type="type" :series-index="index" option-key="center.x"  :ui="['number-px','number-%']" :min="0" :max="1400" :step="1"></property-switch>
    <property-switch label="外:"  :component-type="type" :series-index="index" option-key="center.y" :ui="['number-px','number-%']" :min="0" :max="100" :step="1"></property-switch>-->
    <property-number label="饼图起始角度"  :component-type="type" :series-index="index" option-key="startAngle" unit="°" :min="-180" :max="180" :step="1" ></property-number>
    ...
    <Group :tabs="[{label:'普通状态',name:'normal'},{label:'高亮状态',name:'emphasis'}]">
      ...
      <div class="content" slot="emphasis">
        ...
        <property-text label="文本标签距圆心距离与半径比值" :component-type="type" :series-index="index" option-key="itemStyle.emphasis.label.distance"></property-text>
        <property-select label="文本标签内容模板" :component-type="type" :series-index="index" option-key="itemStyle.emphasis.label.formatter"></property-select>
