...
import { Slider, Input,Button,Table,TableColumn,Form,FormItem,Select,Option,Collapse,
  CollapseItem,ColorPicker,Upload,InputNumber,Cascader,Checkbox,radioButton,radioGroup,Switch} from 'element-ui'
...
const uiComponent = {
  ...
  VueDraggableResizable,Checkbox,radioButton,radioGroup,Switch,
