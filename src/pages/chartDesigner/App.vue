<template>
  <div id="app" style="height: 100vh;min-width:1200px">
...
<!--第三方依赖样式-->
<style>
  @import "../../style/third/element/themes/icon.css";
  ...
  @import "../../style/third/element/themes/form.css";
  @import "../../style/third/element/themes/select.css";
