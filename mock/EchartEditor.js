...
const Column=Mock.mock({
  ...
  'data|6': [
    {
      "column|+1": ["id","name","age","height","sex","weight"],
      "type|1": ["String","Integer","Float","Timestamp","Date"],
      "format": null,
      "alias|+1": ["ID","姓名","年龄","身高","性别","体重"],
      "index|+1": 0
    },
  ]
})
//queryFns.do
//fnList
const fnList=Mock.mock({
  "success": true,
  'data|5': [
    {
      "id|1000-23400":1000,
      "className": "com.ys.visual.module.system.widgets.dsmanage.@word",
      "beanName": "@cword",
      "name": "@name",
      "cnname": "@cname",
      "status": "1",
...
module.exports = {
  [`GET ${apiPrefix}/text-option/load`] (req, res) {
    res.json(textScript)
  },
  [`POST ${apiPrefix}/callBean.do`](req, res){
    console.log(req.body)
    res.json(Data)
  },
  [`GET ${apiPrefix}/queryFns.do`](req, res){
    res.json(fnList)
  },
  [`GET ${apiPrefix}/getColumns.do`](req, res){
    res.json(Column)
  }
}
